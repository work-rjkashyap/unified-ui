...
const _TOKENS_DIR = join(DS_SRC, "tokens");
const _THEME_DIR = join(DS_SRC, "theme");
const _PRIMITIVES_DIR = join(DS_SRC, "primitives");
...
// ---------------------------------------------------------------------------
const _INTERNAL_FILE_CATEGORIES = {
  ...
  const registryItemSchema = {
    ...
    properties: {
      ...
      status: {
        type: "string",
        enum: ["new", "updated"],
        description: "Indicates if the component is new or recently updated",
      },
      sinceVersion: {
        type: "string",
        description:
