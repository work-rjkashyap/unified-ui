...
const REGISTRY_HOMEPAGE = "https://unified-ui.vercel.app";
...
const COMPONENT_META = {
  ...
  "alert-dialog": {
    title: "Alert Dialog",
    description: "Blocking confirmation dialog that requires explicit user action.",
    category: "overlay",
  },
  alert: {
    title: "Alert",
    description: "5 semantic variants with auto icons, dismissible, collapsible, animated entrance.",
    category: "feedback",
  },
  "aspect-ratio": {
    title: "Aspect Ratio",
  ...
  badge: {
    title: "Badge",
    description: "8 semantic variants, dot indicator, avatar/icon slots, removable.",
    category: "data-display",
  },
  banner: {
    title: "Banner",
    description: "Full-width dismissible announcement banner with slide animation.",
    category: "feedback",
  },
  breadcrumb: {
    title: "Breadcrumb",
  ...
  button: {
    title: "Button",
    description: "4 variants, 3 sizes, loading state, icon support, polymorphic rendering.",
    category: "form",
  },
  calendar: {
    title: "Calendar",
    description: "Month/year grid calendar with single and range selection.",
    category: "form",
  },
  card: {
    title: "Card",
  ...
  code: {
    title: "Code",
    description: "Inline code and code block with copy button, line numbers, and syntax highlighting.",
    category: "data-display",
  },
  collapsible: {
    title: "Collapsible",
    description: "Animated show/hide section with smooth height transitions.",
    category: "navigation",
  },
  "color-picker": {
    title: "Color Picker",
    description: "Color selection with spectrum picker, hue slider, HEX input, and presets.",
    category: "form",
  },
  combobox: {
    title: "Combobox",
    description: "Searchable select with single and multi-select, grouped options.",
    category: "form",
  },
  command: {
    title: "Command",
  ...
  "data-list": {
    title: "Data List",
    description: "Semantic key-value pair list with horizontal/vertical layouts.",
    category: "data-display",
  },
  "data-table-toolbar": {
    title: "Data Table Toolbar",
    description: "Filtering, sorting, column visibility toolbar for DataTable.",
    category: "data-display",
  },
  "data-table": {
    title: "Data Table",
    description: "Full-featured table with TanStack Table: sorting, filtering, pagination.",
    category: "data-display",
  },
  "date-picker": {
    title: "Date Picker",
    description: "Date or date-range input with calendar popover and locale formatting.",
    category: "form",
  },
  dialog: {
    title: "Dialog",
  ...
  drawer: {
    title: "Drawer",
    description: "Bottom drawer with drag-to-dismiss interaction. Built on vaul.",
    category: "overlay",
  },
  "dropdown-menu": {
    title: "Dropdown Menu",
  ...
  "empty-state": {
    title: "Empty State",
    description: "Placeholder for empty lists with animated icon, title, and CTA.",
    category: "feedback",
  },
  "file-upload": {
    title: "File Upload",
    description: "Drag-and-drop file upload zone with file list and progress.",
    category: "form",
  },
  "form-field": {
    title: "Form Field",
    description: "Composable field wrapper: label + control + description + error.",
    category: "form",
  },
  "hover-card": {
    title: "Hover Card",
  ...
  "infinite-scroll": {
    ...
    description: "Scroll-triggered infinite loading with Intersection Observer.",
    category: "navigation",
  },
  "input-group": {
    title: "Input Group",
  ...
  kbd: {
    title: "Kbd",
    description: "Keyboard shortcut display in a styled monospaced element.",
    category: "data-display",
  },
  label: {
    title: "Label",
    description: "Accessible label with required indicator and description text.",
    category: "form",
  },
  markdown: {
    title: "Markdown",
    description: "Renders markdown strings into styled HTML with prose styling.",
    category: "data-display",
  },
  menubar: {
    title: "Menubar",
  ...
  "number-input": {
    title: "Number Input",
    description: "Numeric stepper with +/− buttons, keyboard nav, min/max clamping.",
    category: "form",
  },
  pagination: {
    title: "Pagination",
  ...
  progress: {
    title: "Progress",
    description: "Linear progress bar with indeterminate, striped, and labeled variants.",
    category: "feedback",
  },
  radio: {
    title: "Radio",
  ...
  "scroll-area": {
    title: "Scroll Area",
    description: "Custom scrollbar container for consistent cross-browser appearance.",
    category: "navigation",
  },
  "search-input": {
    title: "Search Input",
    description: "Search field with debounce, clear button, and keyboard shortcut hint.",
    category: "form",
  },
  select: {
    title: "Select",
  ...
  sidebar: {
    title: "Sidebar",
    description: "Collapsible app sidebar with sections, icons, and mobile overlay.",
    category: "navigation",
  },
  skeleton: {
    title: "Skeleton",
  ...
  slider: {
    title: "Slider",
    description: "Range slider with single/dual thumb, step marks, and tooltip.",
    category: "form",
  },
  sonner: {
    title: "Sonner",
  ...
  spinner: {
    title: "Spinner",
    description: "Animated loading spinner with 4 sizes and reduced-motion support.",
    category: "feedback",
  },
  stat: {
    title: "Stat",
    description: "KPI card with animated count-up value and trend indicator.",
    category: "data-display",
  },
  steps: {
    title: "Steps",
    description: "Step indicator for multi-stage flows with active/completed states.",
    category: "navigation",
  },
  switch: {
    title: "Switch",
  ...
  "theme-toggle": {
    title: "Theme Toggle",
    description: "Light/dark/system mode switcher with icon and segmented variants.",
    category: "utility",
  },
  timeline: {
    title: "Timeline",
    description: "Vertical timeline with icons, status colors, and stagger animations.",
    category: "data-display",
  },
  toast: {
    title: "Toast",
  ...
  "tree-view": {
    title: "Tree View",
    description: "Expandable tree structure with checkable nodes and keyboard nav.",
    category: "navigation",
  },
  "video-player": {
    title: "Video Player",
    description: "Styled video with custom controls, poster image, and keyboard shortcuts.",
    category: "data-display",
  },
  "virtual-list": {
    title: "Virtual List",
    description: "Virtualized list that only renders visible items for performance.",
    category: "layout",
  },
  "visually-hidden": {
...
function rewriteImports(source) {
  ...
  result = result.replace(
    ...
    (_, sub) => (sub ? `from "@/lib/motion/${sub}"` : `from "@/lib/motion"`),
  );
...
function buildMotionItem() {
  ...
  return {
    ...
    description: "Framer Motion animation presets — fadeIn, slideUp, scaleIn, stagger.",
    category: "motion",
    client: false,
...
function buildStylesItem() {
  ...
  return {
    ...
    description: "CSS custom properties and Tailwind v4 theme integration for Unified UI.",
    category: "theme",
    client: false,
    exports: [],
    dependencies: [],
  ...
  const registrySchema = {
    ...
    $defs: {
      indexItem: {
        ...
        properties: {
          name: { type: "string", description: "Unique component identifier (kebab-case)" },
          type: {
            type: "string",
            enum: ["unified-ui:component", "unified-ui:util", "unified-ui:styles"],
  ...
  const registryItemSchema = {
    ...
    properties: {
      ...
      category: {
        type: "string",
        enum: [
          "form", "data-display", "feedback", "overlay",
          "navigation", "layout", "utility", "utils", "motion", "theme",
        ],
      },
      client: { type: "boolean", description: "Whether this is a 'use client' component" },
      exports: {
        type: "array",
        items: { type: "string" },
      ...
      dependencies: {
        type: "array",
        items: { type: "string" },
        description: "npm packages required (e.g. framer-motion, radix-ui)",
      },
      registryDependencies: {
        type: "array",
        items: { type: "string" },
        description: "Other unified-ui registry items this depends on (by name)",
      },
      internalDependencies: {
        type: "object",
        properties: {
          utils: {
            type: "array",
            items: { type: "string" },
            description: "Required utility files (e.g. cn, focus-ring)",
          },
          motion: {
            type: "boolean",
      ...
      files: {
        ...
        items: {
          ...
          properties: {
            ...
            type: {
              type: "string",
              enum: ["component", "util", "styles", "hook", "config"],
            },
            target: {
              type: "string",
              description: "Target path in the user's project (relative to src/)",
            },
          },
        },
      },
