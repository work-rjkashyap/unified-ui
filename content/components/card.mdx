...
```tsx
import { Card, CardHeader, CardBody, CardFooter } from "@work-rjkashyap/unified-ui";
```
...
<div className="flex flex-col gap-4 max-w-sm not-prose">
	<Card>
		<CardBody>
			<p className="font-medium text-sm">Default Card</p>
			<p className="text-sm text-ds-muted-foreground">
				Subtle background with a standard border. Blends into the page
				naturally.
			</p>
		</CardBody>
	</Card>
...
<div className="flex flex-col gap-4 max-w-sm not-prose">
	<Card variant="interactive" as="a" href="#interactive">
		<CardBody>
			...
			<p className="text-sm text-ds-muted-foreground">
				Hover to see the lift effect. Includes focus ring for keyboard
				users.
			</p>
		</CardBody>
	</Card>
...
<div className="flex flex-col gap-4 max-w-sm not-prose">
	<Card>
		<CardHeader bordered={false}>
			<h3 className="text-base font-semibold">No Border Header</h3>
		</CardHeader>
		<CardBody>
			<p className="text-sm">
...
```tsx
<Card padding="compact">   {/* p-4 — default */}
...
<div className="flex flex-col gap-4 max-w-md not-prose">
	<Card>
		<CardBody>
...
```tsx
<CardFooter align="end">      {/* Default — right-aligned */}
...
<div className="not-prose">
	<Card fullWidth>
		<CardBody>
			<p className="text-sm">
				This card stretches to fill its container width using the{" "}
