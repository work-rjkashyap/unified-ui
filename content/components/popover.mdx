...
import { Popover, PopoverTrigger, PopoverContent, PopoverClose, PopoverArrow, Button, Input } from "@work-rjkashyap/unified-ui";
...
<div className="my-6 flex justify-center not-prose">
  <Popover>
    ...
    <PopoverContent arrow>
      <p className="text-sm">This popover has a pointing arrow.</p>
    </PopoverContent>
  </Popover>
</div>
...
<div className="my-6 flex justify-center not-prose">
  <Popover>
    <PopoverTrigger asChild>
      <Button variant="secondary" size="sm">With Close Button</Button>
    </PopoverTrigger>
    <PopoverContent showClose>
      <div className="space-y-2 pr-4">
        <h4 className="text-sm font-semibold">Notification settings</h4>
        <p className="text-xs text-ds-muted-foreground">Choose which notifications you'd like to receive.</p>
      </div>
    </PopoverContent>
  </Popover>
</div>
