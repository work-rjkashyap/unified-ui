...
<div className="my-6 flex gap-3 items-end justify-center">
...
<div className="my-6 flex gap-3 items-center justify-center">
...
```tsx
<Avatar name="Jane" status="online" />   {/* Green dot */}
