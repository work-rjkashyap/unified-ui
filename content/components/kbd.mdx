...
<ComponentPage
  title="Kbd"
  description="Displays keyboard keys and shortcuts in a styled, monospaced element with a tactile inset shadow."
  preview={
...
import { Kbd } from "@work-rjkashyap/unified-ui";
// or
import { Kbd } from "@work-rjkashyap/unified-ui/components";
```
...
<ComponentPage
  ...
  description="Multi-key shortcuts using separator characters between Kbd elements."
  preview={
...
<ComponentPage
  ...
  description="Listing keyboard shortcuts in a reference table."
  preview={
