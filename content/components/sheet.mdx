...
import { Sheet, SheetTrigger, SheetContent, SheetHeader, SheetFooter, SheetTitle, SheetDescription, SheetClose, Button, Input } from "@work-rjkashyap/unified-ui";
...
<div className="my-6 flex flex-wrap gap-3 items-center justify-center not-prose">
  <Sheet>
    <SheetTrigger asChild>
    ...
    <SheetContent side="right">
      ...
      <div className="p-6 text-sm text-ds-muted-foreground">
        This is the default side. Ideal for detail panels, settings, and forms.
      </div>
    </SheetContent>
  </Sheet>
  <Sheet>
  ...
  <Sheet>
    ...
    <SheetContent side="top">
      ...
      <div className="p-6 text-sm text-ds-muted-foreground">
        Useful for search bars, announcements, or command palettes.
      </div>
    </SheetContent>
  </Sheet>
  <Sheet>
...
<Sheet>
  ...
  <SheetContent side="left" size="sm">
    ...
    <nav className="flex flex-col gap-1 p-4">
      <a href="/" className="px-3 py-2 text-sm rounded-ds-md hover:bg-ds-muted">
        Home
      </a>
      <a href="/docs" className="px-3 py-2 text-sm rounded-ds-md hover:bg-ds-muted">
        Documentation
      </a>
      <a href="/components" className="px-3 py-2 text-sm rounded-ds-md hover:bg-ds-muted">
        Components
      </a>
      <a href="/examples" className="px-3 py-2 text-sm rounded-ds-md hover:bg-ds-muted">
        Examples
      </a>
    </nav>
  </SheetContent>
...
<Sheet>
  ...
  <SheetContent side="right" size="md">
    <SheetHeader>
      ...
      <SheetDescription>
        Update your project configuration. Changes are saved when you click Save.
      </SheetDescription>
    </SheetHeader>
