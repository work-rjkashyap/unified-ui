...
<ComponentPage
	title="Combobox"
	description="A production-ready searchable select / autocomplete built by composing Popover + Command primitives with Framer Motion animation. Supports single and multi-select, grouped options, custom rendering, and keyboard navigation."
	preview={
...
<ComponentPage
	title="Variants"
	description="Default uses a standard border; primary uses a tinted primary border."
	preview={
		<div className="w-full max-w-sm flex flex-col gap-3">
			<Combobox
				options={[
...
<ComponentPage
	title="Multi-Select"
	description="Select multiple options. Chosen items appear as removable tags in the trigger area."
	preview={
		<div className="w-full max-w-sm">
			<Combobox
				multi
...
<ComponentPage
	...
	description="Options are organized into labeled sections for better scannability."
	preview={
		<div className="w-full max-w-sm">
			<Combobox
				groups={[
...
<ComponentPage
	...
	description="Behaves like a traditional select dropdown without the search input."
	preview={
		<div className="w-full max-w-sm">
			<Combobox
				searchable={false}
