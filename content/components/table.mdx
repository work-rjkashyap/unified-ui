...
<ComponentPage
	...
	preview={
		<div className="flex flex-col gap-6 w-full max-w-lg">
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2 font-medium">Compact</p>
			...
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2 font-medium">Comfortable (default)</p>
...
| Token                         | Usage                                     |
| ----------------------------- | ----------------------------------------- |
| `--ds-color-surface`          | Table background                          |
| `--ds-color-border-muted`     | Row borders                               |
| `--ds-color-muted`            | Striped row background, footer background |
| `--ds-color-foreground`       | Header and cell text                      |
| `--ds-color-muted-foreground` | Caption text                              |
| `--ds-duration-fast`          | Hover transition speed                    |
