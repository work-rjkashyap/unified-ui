...
import { Table, TableHeader, TableBody, TableFooter, TableRow, TableHead, TableCell, TableCaption, Badge } from "@work-rjkashyap/unified-ui";
...
```tsx
{/* Compact — less vertical padding, good for dense data */}
...
<div className="overflow-x-auto rounded-ds-md border border-ds-border">
  <Table>
    ...
    <TableBody>
      {/* Many columns that may overflow */}
    </TableBody>
  </Table>
</div>
```
