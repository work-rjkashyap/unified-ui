...
<ComponentPage
	title="Basic Menu"
	description="A simple dropdown menu with standard menu items."
	preview={
...
<ComponentPage
	...
	description="Use labels to add section headings and separators to visually divide groups."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	title="Grouped Items"
	description="Logically group related items for semantic grouping and assistive technology."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	...
	description="Display keyboard shortcut hints alongside menu items. The hint is purely visual — you handle actual key bindings separately."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	title="Submenus"
	description="Nest submenus using DropdownMenuSub, DropdownMenuSubTrigger, and DropdownMenuSubContent."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	...
	description="Togglable menu items with checkmark indicators. Manage the checked state externally with useState."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	title="Radio Items"
	description="Single-select option groups within a dropdown menu using radio items."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	title="onSelect Handler"
	description="Each menu item fires an onSelect callback when clicked or activated via keyboard."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
...
<ComponentPage
	title="Kitchen Sink"
	description="A comprehensive example combining labels, groups, shortcuts, checkboxes, submenus, and danger items."
	preview={
		<div className="flex gap-3 items-center justify-center">
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
