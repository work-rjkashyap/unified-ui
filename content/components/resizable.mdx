...
<ComponentPage
	title="Resizable"
	description="Resizable split panels with a drag handle for building adjustable layouts. Supports horizontal and vertical directions, default sizes, and an optional grip handle indicator."
	preview={
...
<ComponentPage
	...
	description="Panels are arranged side by side with a vertical drag handle between them."
	preview={
...
<ComponentPage
	...
	description="Panels are stacked vertically with a horizontal drag handle between them."
	preview={
...
<ComponentPage
	title="Grip Handle"
	description="A visible grip icon on the handle improves discoverability for drag resizing."
	preview={
		<div className="w-full max-w-lg h-40 rounded-lg border border-border overflow-hidden">
			<ResizablePanelGroup direction="horizontal">
				<ResizablePanel defaultSize={50}>
...
<ComponentPage
	title="Three Panels"
	description="Multiple panels with handles between each pair."
	preview={
		<div className="w-full max-w-lg h-40 rounded-lg border border-border overflow-hidden">
			<ResizablePanelGroup direction="horizontal">
