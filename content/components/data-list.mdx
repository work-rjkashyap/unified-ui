...
<ComponentPage
  title="Data List"
  description="A semantic key-value pair list for structured metadata display. Supports horizontal (grid) and vertical layouts, dividers, and staggered Framer Motion entrance animations."
  preview={
...
```tsx
import { DataList } from "@work-rjkashyap/unified-ui";
// or
import { DataList } from "@work-rjkashyap/unified-ui/components";
```
...
<ComponentPage
  ...
  description="Two-column grid with aligned terms and details — the default layout."
  preview={
    <div className="w-full max-w-md">
      <DataList
...
<ComponentPage
  ...
  description="Stacked layout with the term rendered above its detail value."
  preview={
...
<ComponentPage
  title="With Dividers"
  description="Horizontal rules between each item for clear visual separation."
  preview={
    <div className="w-full max-w-md">
      <DataList
        dividers
...
<ComponentPage
  title="Sizes"
  description="Small, medium, and large text sizes for different density levels."
  preview={
...
<ComponentPage
  title="Rich Detail Values"
  description="Embed any ReactNode as a term or detail — badges, links, status dots, and more."
  preview={
    <div className="w-full max-w-md">
      <DataList
        dividers
