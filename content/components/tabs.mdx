		...
		<div className="flex flex-col gap-6 w-full max-w-md">
			<div>
				...
				<Tabs size="sm" defaultValue="tab1">
					...
					<TabsContent value="tab1">
						<div className="p-4 text-sm text-ds-muted-foreground">Small tab content</div>
					</TabsContent>
					<TabsContent value="tab2">
						<div className="p-4 text-sm text-ds-muted-foreground">Small tab 2 content</div>
					</TabsContent>
				</Tabs>
			</div>
			<div>
				...
				<Tabs size="md" defaultValue="tab1">
					...
					<TabsContent value="tab1">
						<div className="p-4 text-sm text-ds-muted-foreground">Medium tab content</div>
					</TabsContent>
					<TabsContent value="tab2">
						<div className="p-4 text-sm text-ds-muted-foreground">Medium tab 2 content</div>
					</TabsContent>
				</Tabs>
			</div>
		</div>
