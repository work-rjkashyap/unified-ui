...
<ComponentPage
  title="Code"
  description="Two composable code display components: InlineCode for short snippets within prose, and CodeBlock for multi-line code with copy button, line numbers, filename label, and dark/light variants."
  preview={
...
```tsx
import { InlineCode, CodeBlock } from "@work-rjkashyap/unified-ui";
// or
import { InlineCode, CodeBlock } from "@work-rjkashyap/unified-ui/components";
```
...
<ComponentPage
  title="InlineCode in Prose"
  description="InlineCode is an inline element that flows naturally within text content."
  preview={
...
<ComponentPage
  ...
  description="The header bar shows the filename on the left and the language badge on the right."
  preview={
...
<ComponentPage
  title="Copy Button"
  description="The built-in copy button shows a Copied! confirmation after a successful clipboard write."
  preview={
    <div className="w-full max-w-lg">
...
<ComponentPage
  title="Line Numbers"
  description="Line numbers are rendered in the gutter alongside the code."
  preview={
    <div className="w-full max-w-lg">
...
<ComponentPage
  title="Dark Variant"
  description="A high-contrast dark code block for dark-themed sections or prominent code display."
  preview={
    <div className="w-full max-w-lg">
...
<ComponentPage
	title="InlineCode + CopyButton"
	description="Combine InlineCode with a standalone CopyButton for copyable inline snippets."
	preview={
