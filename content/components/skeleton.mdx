...
import { Skeleton, SkeletonText, SkeletonCircle, SkeletonRect } from "@work-rjkashyap/unified-ui";
...
import { Skeleton, SkeletonText, SkeletonCircle, SkeletonRect } from "@work-rjkashyap/unified-ui";
// or
import { Skeleton, SkeletonText, SkeletonCircle, SkeletonRect } from "@work-rjkashyap/unified-ui/components";
```
...
<div className="my-6 flex flex-col gap-4 max-w-sm">
  <div>
    <p className="text-xs text-ds-muted-foreground mb-2">Small</p>
    <SkeletonText lines={2} size="sm" />
  </div>
  <div>
    <p className="text-xs text-ds-muted-foreground mb-2">Medium (default)</p>
...
<div className="my-6 max-w-sm border border-ds-border rounded-ds-md p-4 not-prose">
...
<div className="my-6 max-w-sm not-prose flex flex-col gap-4">
...
<div className="my-6 max-w-md not-prose flex flex-col gap-3">
  {[1, 2, 3].map((i) => (
