...
<ComponentPage
	...
	preview={
		<div className="flex flex-col gap-6 max-w-sm w-full">
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2">1 line</p>
				<SkeletonText lines={1} />
			</div>
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2">3 lines</p>
				<SkeletonText lines={3} />
			</div>
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2">5 lines</p>
...
<ComponentPage
	...
	preview={
		<div className="flex flex-col gap-4 max-w-sm w-full">
			<div>
				<p className="text-xs text-ds-muted-foreground mb-2">Small</p>
...
<ComponentPage
	...
	preview={
		<div className="max-w-sm w-full border border-ds-border rounded-ds-md p-4">
...
| Token              | Usage                            |
| ------------------ | -------------------------------- |
| `--ds-color-muted` | Skeleton placeholder background  |
| `--ds-radius-sm`   | Text line and rect border radius |
| `--ds-radius-full` | Circle shape border radius       |
