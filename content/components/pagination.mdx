...
<ComponentPage
	...
	description="Standard pagination with individual page number buttons, ellipsis, and prev/next controls."
	preview={
...
<ComponentPage
	...
	description="Two sizes for different density requirements."
	preview={
...
<ComponentPage
	title="Smart Ellipsis"
	description="Intelligent truncation that adapts based on the current page position — hiding left or right ellipsis as needed."
	preview={
		<div className="flex flex-col gap-4 items-center w-full">
...
<ComponentPage
	title="Small Page Counts"
	description="When the total page count is small enough, all pages are shown without ellipsis."
	preview={
		<div className="flex flex-col gap-4 items-center w-full">
