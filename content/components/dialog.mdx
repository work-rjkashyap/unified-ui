...
import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogBody, DialogFooter, DialogTitle, DialogDescription, DialogClose, Button, Input } from "@work-rjkashyap/unified-ui";
...
<div className="my-6 flex flex-wrap gap-3 items-center justify-center not-prose">
  <Dialog>
    <DialogTrigger asChild>
      <Button variant="secondary" size="sm">Small (480px)</Button>
    </DialogTrigger>
    <DialogContent size="sm">
      ...
      <DialogBody>
        <p className="text-sm">Ideal for simple confirmations and short forms.</p>
      </DialogBody>
      <DialogFooter>
        <DialogClose asChild>
  ...
  <Dialog>
    <DialogTrigger asChild>
      <Button variant="secondary" size="sm">Medium (560px)</Button>
    </DialogTrigger>
    <DialogContent size="md">
      <DialogHeader>
        <DialogTitle>Medium Dialog</DialogTitle>
        <DialogDescription>Max width: 560px — the default size.</DialogDescription>
      </DialogHeader>
      <DialogBody>
        <p className="text-sm">Good for most forms and content dialogs.</p>
      </DialogBody>
      <DialogFooter>
        <DialogClose asChild>
          <Button variant="secondary" size="sm">Close</Button>
  ...
  <Dialog>
    <DialogTrigger asChild>
      <Button variant="secondary" size="sm">Large (720px)</Button>
    </DialogTrigger>
    <DialogContent size="lg">
      ...
      <DialogBody>
        <p className="text-sm">For complex forms, settings panels, or data-heavy content.</p>
      </DialogBody>
      <DialogFooter>
        <DialogClose asChild>
          <Button variant="secondary" size="sm">Close</Button>
...
<div className="my-6 flex gap-3 items-center justify-center not-prose">
  <Dialog>
    <DialogTrigger asChild>
