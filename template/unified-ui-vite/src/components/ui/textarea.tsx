...
import { cn, composeRefs } from "@/lib/cn";
...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  function Textarea(
    ...
    const [uncontrolledCharCount, setUncontrolledCharCount] = useState<number>(
      () => {
    ...
    // Derive char count during render for controlled components instead of
    // syncing via useEffect. For uncontrolled, track via onChange handler.
    const charCount =
      value !== undefined ? String(value).length : uncontrolledCharCount;
