      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="https://unified-ui.space/docs">
              <Button
                variant="primary"
                size="sm"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <p className="text-base text-muted-foreground leading-7 max-w-xl">
            This starter template is pre-wired with{" "}
            ...
            is mounted in your root layout, styles are imported, and every
            component is ready to use. Edit{" "}
            <code className="text-sm font-mono bg-muted px-1.5 py-0.5 rounded">
              app/page.tsx
            </code>{" "}
            to get started.
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="https://unified-ui.space/components">
        ...
        <section>
          <Card className="border-primary/20 bg-primary/5">
            <CardBody className="p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <Link href="https://unified-ui.space/docs" className="shrink-0">
                <Button
                  variant="primary"
                  size="sm"
                  iconRight={<ArrowRight className="size-3.5" />}
