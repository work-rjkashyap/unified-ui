  ...
  return (
    <>
      ...
      <Base.SidebarDrawerContent
        className={cn(
          "fixed text-sm flex flex-col shadow-2xl border-s border-fd-border/40 end-0 inset-y-0 w-[85%] max-w-[320px] z-60 bg-fd-background/60 backdrop-blur-xl data-[state=open]:animate-fd-sidebar-in data-[state=closed]:animate-fd-sidebar-out overflow-hidden",
          className,
        )}
        {...props}
      >
