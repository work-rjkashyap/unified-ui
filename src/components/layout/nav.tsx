...
const DS_VERSION = "0.2.x";

const NAV_LINKS = [
	{ text: "Docs", url: "/docs", activeMatch: "nested-url" as const },
	{
		text: "Components",
		url: "/components",
		activeMatch: "nested-url" as const,
	},
	{ text: "Blocks", url: "/blocks", activeMatch: "url" as const },
	{ text: "Colors", url: "/colors", activeMatch: "url" as const },
	{ text: "Themes", url: "/themes", activeMatch: "url" as const },
];

export const Nav = () => {
	const { setOpenSearch } = useSearchContext();
	const { open, setOpen } = useSidebar();
	const { menuItems } = useLinkItems(baseOptions);
					...
					<button
						...
						className={cn(
							buttonVariants({
								...
								size: "icon",
								className:
									"md:hidden size-9 text-fd-muted-foreground",
							}),
						)}
