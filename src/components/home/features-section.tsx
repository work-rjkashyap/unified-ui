...
const colorMap: Record<
  string,
  {
    badge: "primary" | "info" | "success" | "warning" | "danger" | "default";
    dot: string;
    border: string;
  }
> = {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-base text-fd-muted-foreground leading-7 max-w-xl mx-auto">
            Organized into strict, dependency-ordered layers — no upward
            imports. Composable by design, predictable by architecture.
          </p>
        </div>
