...
const fullColumns: ColumnDef<User, unknown>[] = [
...
const simpleColumns: ColumnDef<User, unknown>[] = [
  { accessorKey: "id", header: "Invoice" },
  { accessorKey: "name", header: "Name" },
  { accessorKey: "email", header: "Email" },
  { accessorKey: "role", header: "Role" },
...
const pinnedColumns: ColumnDef<User, unknown>[] = [
...
const wideColumns: ColumnDef<User, unknown>[] = [
...
const taskData: Task[] = [
  {
    id: "TASK-7493",
    title:
      "The OCR matrix is down, navigate the virtual feed so we can program the ...",
    label: "feature",
    status: "In-Progress",
    priority: "Low",
    estHours: 14,
  ...
  },
  {
    id: "TASK-2048",
    title:
      "I'll back up the virtual VGA sensor, that should protocol the SDD applicati...",
    label: "enhancement",
    status: "In-Progress",
    priority: "Low",
    estHours: 19,
  ...
  },
  {
    id: "TASK-8557",
    title:
      "Try to hack the GB transmitter, maybe it will generate the multi-byte firew...",
    label: "bug",
    status: "Todo",
    priority: "Low",
    estHours: 24,
  ...
  },
  {
    id: "TASK-4375",
    title:
      "If we bypass the interface, we can get to the THX panel through the back-...",
    label: "enhancement",
    status: "In-Progress",
    priority: "Low",
    estHours: 19,
  ...
  },
  {
    id: "TASK-3202",
    title:
      "I'll program the online HDD array, that should bus the DRAM matrix!",
    label: "documentation",
    status: "In-Progress",
    priority: "Low",
    estHours: 10,
  ...
  },
  {
    id: "TASK-2496",
    title:
      "Connecting the pixel won't do anything, we need to connect the multi-byt...",
    label: "feature",
    status: "In-Progress",
    priority: "Low",
    estHours: 19,
  ...
  },
  {
    id: "TASK-4272",
    title:
      "Programming the protocol won't do anything, we need to calculate the sol...",
    label: "feature",
    status: "In-Progress",
    priority: "Medium",
    estHours: 11,
  ...
  },
  {
    id: "TASK-8142",
    title:
      "Use the primary GB capacitor, then you can parse the bluetooth microchip!",
    label: "enhancement",
    status: "In-Progress",
    priority: "Low",
    estHours: 22,
  ...
  },
  {
    id: "TASK-5700",
    title:
      "I'll compress the mobile GB card, that should alarm the UDP application!",
    label: "feature",
    status: "In-Progress",
    priority: "Medium",
    estHours: 8,
  ...
  },
  {
    id: "TASK-9876",
    title:
      "The TCP interface is down, quantify the digital panel so we can hack...",
    label: "feature",
    status: "Done",
    priority: "Medium",
    estHours: 16,
  ...
  },
  {
    id: "TASK-5432",
    title:
      "Synthesizing the driver won't do anything, we need to navigate the back-end...",
    label: "documentation",
    status: "In-Progress",
    priority: "Low",
    estHours: 6,
  ...
  },
  {
    id: "TASK-6789",
    title:
      "Try to override the SAS transmitter, maybe it will override the cross-platform...",
    label: "bug",
    status: "Cancelled",
    priority: "High",
    estHours: 28,
...
const taskColumns: ColumnDef<Task, unknown>[] = [
  ...
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return (
        <div className="flex items-center gap-1.5">
          <span className="text-muted-foreground">{statusIconMap[status]}</span>
          <span className="text-sm">{status}</span>
        </div>
      );
    },
      ...
      return (
        <DataTable
          ...
          toolbar={(table) => {
            ...
            return count > 0 ? (
              <span className="text-xs font-medium text-primary">
                {count} of {table.getFilteredRowModel().rows.length} row(s)
                selected
              </span>
            ) : null;
          }}
