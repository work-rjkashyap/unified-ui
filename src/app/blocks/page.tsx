...
export const metadata: Metadata = {
	...
	description:
		"Pre-built, composable page sections and layouts. Coming soon.",
};
	...
	return (
		<div className="flex flex-col items-center justify-center min-h-[80dvh] px-4 text-center">
			...
			<p className="text-base text-fd-muted-foreground max-w-md mx-auto leading-relaxed mb-10">
				Pre-built, composable page sections and layouts to help you ship
				landing pages, dashboards, and marketing sites faster with
				Unified UI.
			</p>
			<Link
				href="/"
