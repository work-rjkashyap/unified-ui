...
const NOTIFICATIONS = [
	{
		...
		description: "Olivia Martin commented on your recent update.",
		time: "2 min ago",
		unread: true,
	},
	{
		title: "Deployment succeeded",
		description: "Your latest deployment to production completed.",
		time: "15 min ago",
		unread: true,
	},
	{
		title: "You were mentioned",
		description: "Jackson Lee mentioned you in #design-system.",
		time: "1 hour ago",
		unread: false,
	},
	{
		title: "Weekly report ready",
		description: "Your workspace activity report for this week.",
		time: "3 hours ago",
		unread: false,
	},
];
	...
	return (
		<TooltipProvider>
			<div className="space-y-4">
				...
				<Card>
					<CardHeader>
						<h3 className="text-sm font-semibold">Dialogs</h3>
				...
				<Card>
					<CardHeader>
						...
						<p className="text-xs text-muted-foreground">
							Contextual actions, navigation, and option
							selection.
						</p>
					</CardHeader>
					<CardBody>
				...
				<Card>
					<CardHeader>
						<h3 className="text-sm font-semibold">Popovers</h3>
						<p className="text-xs text-muted-foreground">
							Rich floating panels for notifications, sharing, and
							quick actions.
						</p>
					</CardHeader>
					<CardBody>
