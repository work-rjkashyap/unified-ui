				...
				<div className="col-span-6 lg:col-span-4">
					...
					>
						<div className="flex items-end gap-1.5 h-32 mt-1">
							{[
								40, 65, 45, 80, 55, 90, 70, 85, 60, 75, 95, 50,
							].map((h, i) => (
								<Tooltip
									key={i}
					...
					>
						<Tabs defaultValue="overview">
							...
							<TabsContent value="overview" className="mt-3">
								<div className="space-y-3">
									<p className="text-sm text-muted-foreground">
										Welcome to the overview tab. This shows
							...
							<TabsContent value="analytics" className="mt-3">
								<p className="text-sm text-muted-foreground">
									Analytics data is updated hourly. Last
									updated 15 minutes ago.
								</p>
							</TabsContent>
							<TabsContent value="reports" className="mt-3">
								<p className="text-sm text-muted-foreground">
									Generate custom reports by selecting date
									ranges and metrics.
								</p>
							</TabsContent>
						</Tabs>
					...
					>
						<Accordion type="single" defaultValue="item-1">
							<AccordionItem value="item-1">
								...
								<AccordionContent>
									A token-driven design system for React built
									with Tailwind CSS v4, Radix UI, and Framer
									Motion.
								</AccordionContent>
							</AccordionItem>
							...
							<AccordionItem value="item-3">
								...
								<AccordionContent>
									Absolutely. Use the theme customizer to
									change colors, fonts, radius, and more.
								</AccordionContent>
							</AccordionItem>
						</Accordion>
					</BentoCard>
