    ...
    <TooltipProvider>
      <div className="grid grid-cols-6 gap-3">
          ...
          >
            <div className="space-y-2">
              <Alert variant="info" title="Info">
                This is an informational note. It provides helpful context or
                guidance.
              </Alert>
              <Alert variant="warning" title="Warning">
                This is a warning note. Please review before proceeding.
              </Alert>
              <Alert variant="danger" title="Danger">
                This is a danger note. Immediate action may be required.
              </Alert>
              <Alert variant="success" title="Success">
                This is a success note. Your action completed successfully.
              </Alert>
              <Alert variant="default" title="Default">
                This is a default note with neutral styling for general
                messages.
              </Alert>
            </div>
          </BentoCard>
        ...
        <div className="col-span-6 md:col-span-3">
          ...
          >
            <div className="space-y-2">
              <Alert variant="info" title="New feature available" dismissible>
                We've added dark mode support. Try it out in your settings.
              </Alert>
              <Alert variant="success" title="Deployment complete" dismissible>
                Your latest changes have been deployed to production
                successfully.
              </Alert>
              <Alert variant="warning" title="Disk usage high" dismissible>
        ...
        <div className="col-span-6 md:col-span-3">
          ...
          >
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-medium">Danger</span>
                  <span className="text-xs text-muted-foreground tabular-nums">
                    25%
                  </span>
                </div>
              ...
              <div className="space-y-1.5">
                <span className="text-xs font-medium">Indeterminate</span>
                <Progress indeterminate />
              </div>
              <div className="space-y-1.5">
                <span className="text-xs font-medium">Striped</span>
              ...
              {[
                ...
                >
                  <CardBody className="p-4 flex flex-col">
                    ...
                    <Button variant={plan.variant} size="sm" fullWidth>
                      {plan.cta}
                    </Button>
                  </CardBody>
                </Card>
