  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem variant="danger">Delete invoice</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
}
          ...
          <TableBody>
            {PAYMENTS.map((payment) => (
              <TableRow key={payment.id}>
                <TableCell>
                  <Checkbox size="sm" aria-label={`Select ${payment.id}`} />
                </TableCell>
                <TableCell>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <Button variant="primary" size="sm" className="min-w-[2rem]">
              1
            </Button>
            <Button variant="ghost" size="sm" className="min-w-[2rem]">
              2
            </Button>
            <Button variant="ghost" size="sm" className="min-w-[2rem]">
              3
