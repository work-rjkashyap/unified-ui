  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...menuItemBase,
        variant === "danger" &&
          "text-ds-danger focus:bg-ds-danger-muted focus:text-ds-danger-muted-foreground",
        variant === "default" && "text-ds-foreground",
        icon && "gap-2",
        className,
      )}
      data-ds=""
...
>(function DropdownMenuLabel({ className, inset, children, ...rest }, ref) {
  return (
    <DropdownMenuPrimitive.Label
      ref={ref}
      className={cn(
        "px-2 py-1.5 text-xs font-semibold text-ds-muted-foreground",
        inset && "pl-8",
        className,
      )}
      {...rest}
...
>(function DropdownMenuSubTrigger(
  ...
  return (
    ...
    >
      ...
      <span className="flex-1">{children}</span>
      <ChevronRightIcon className="ml-auto size-4 text-ds-muted-foreground" />
    </DropdownMenuPrimitive.SubTrigger>
  );
});
...
export function DropdownMenuShortcut({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-xs tracking-widest text-ds-muted-foreground",
        className,
      )}
    >
      {children}
