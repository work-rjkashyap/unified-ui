  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "hr",
    {
      ...
      className: chunk4ON3M3OM_cjs.cn(
        ...
        isVertical ? chunk4ON3M3OM_cjs.cn("w-px self-stretch bg-border", spacingXMap[spacing] ?? "mx-4") : chunk4ON3M3OM_cjs.cn("h-px w-full bg-border", spacingYMap[spacing] ?? "my-4"),
        className
      ),
      "data-ds": "",
  ...
  function InlineCode2({ className, ...rest }, ref) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      Typography,
      {
        ref,
        variant: "code",
        className: chunk4ON3M3OM_cjs.cn("rounded-sm bg-muted px-1.5 py-0.5", className),
        ...rest
      }
    );
  }
