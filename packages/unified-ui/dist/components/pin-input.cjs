...
__export(pin_input_exports, {
  PinInput: () => PinInput,
  pinCellVariants: () => pinCellVariants
});
...
const pinCellVariants = (0, import_class_variance_authority.cva)(
  [
    // Layout
...
const MASK_CHAR = "\u2022";
const PinInput = (0, import_react.forwardRef)(
  function PinInput2({
    length = 6,
    ...
    const [animatedIndex, setAnimatedIndex] = (0, import_react.useState)(null);
    ...
    const prevErrorRef = (0, import_react.useRef)(error);
    (0, import_react.useEffect)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      {
        ref: containerRef,
        className: (0, import_cn.cn)("inline-flex", gap, className),
        variants: import_motion.shakeX.variants,
        initial: shakeKey === 0 ? false : "initial",
        animate: shakeKey > 0 ? "animate" : "initial",
        transition: import_motion.shakeX.transition,
        ...
        children: Array.from({ length }, (_, index) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { children: animatedIndex === index && isFilled && !shouldReduce && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_framer_motion.motion.div,
              {
                className: "absolute inset-0 rounded-md bg-primary/15 pointer-events-none",
                variants: import_motion.pop.variants,
                initial: "initial",
                animate: "animate",
                exit: "exit",
                transition: import_motion.pop.transition,
                "data-ds-animated": ""
              }
            ) }),
