...
function FolderOpenIcon({ className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      "aria-hidden": "true",
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2" })
    }
  );
}
...
const TreeContext = (0, import_react.createContext)({
...
function TreeItem({ node, depth }) {
  const {
    ...
    showIcons,
    shouldReduce
  } = (0, import_react.useContext)(TreeContext);
  ...
  const handleCheckClick = (0, import_react.useCallback)(
    (e) => {
      e.stopPropagation();
      if (node.disabled) return;
      toggleCheck(node.id);
  ...
  if (node.icon) {
    ...
    if (hasChildren) {
      iconNode = isExpanded ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FolderOpenIcon, { className: "size-4 text-muted-foreground shrink-0" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FolderIcon, { className: "size-4 text-muted-foreground shrink-0" });
    } else {
      iconNode = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileIcon, { className: "size-4 text-muted-foreground shrink-0" });
    }
  }
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-flex size-4 items-center justify-center shrink-0", children: hasChildren && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ChevronRightIcon,
                {
                  className: (0, import_cn.cn)(
              ...
              checkable && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "button",
                {
                  type: "button",
                  ...
                  tabIndex: -1,
                  children: [
                    checkState === "checked" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, { className: "size-3" }),
                    checkState === "indeterminate" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MinusIcon, { className: "size-3" })
                  ]
                }
              ),
              iconNode && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "shrink-0", children: iconNode }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "truncate", children: node.label })
            ]
          }
        ),
        hasChildren && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_framer_motion.motion.ul,
          {
            ...
            children: node.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TreeItem, { node: child, depth: depth + 1 }, child.id))
          }
        ) })
      ]
    }
...
const TreeView = (0, import_react.forwardRef)(
  function TreeView2({
    items,
    defaultExpanded = [],
    ...
    const toggleExpand = (0, import_react.useCallback)(
      (id) => {
    ...
    const toggleCheck = (0, import_react.useCallback)(
      (id) => {
    ...
    const getCheckState = (0, import_react.useCallback)(
      (node) => {
        const allIds = collectAllIds(node);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TreeContext.Provider, { value: ctx, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "ul",
      {
        ref,
        className: (0, import_cn.cn)("list-none text-sm", className),
        "data-ds": "",
        "data-ds-component": "tree-view",
        children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TreeItem, { node: item, depth: 0 }, item.id))
      }
    ) });
  }
);
