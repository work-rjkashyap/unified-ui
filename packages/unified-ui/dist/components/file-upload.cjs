...
__export(file_upload_exports, {
  ...
  fileUploadZoneVariants: () => fileUploadZoneVariants
});
...
const fileUploadZoneVariants = (0, import_class_variance_authority.cva)(
  [
...
const FileUpload = (0, import_react.forwardRef)(
  function FileUpload2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      {
        ref,
        className: (0, import_cn.cn)("flex flex-col gap-3 w-full", className),
        "data-ds": "",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              className: (0, import_cn.cn)(fileUploadZoneVariants({ size, state: zoneState })),
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-1 text-center", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "p",
                    {
                      className: (0, import_cn.cn)(
                      ...
                      children: label ?? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-primary underline-offset-2 hover:underline", children: "Click to upload" }),
                        " ",
                        "or drag and drop"
                      ] })
                    }
                  ),
                  description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-muted-foreground", children: description }),
                  accept && !description && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-xs text-muted-foreground", children: [
                    accept,
                    maxSize ? ` \xB7 max ${formatFileSize(maxSize)}` : ""
                  ] })
                ] }),
                error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-1.5 text-xs text-danger", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertCircleIcon, { className: "size-3.5 shrink-0" }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: error })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { initial: false, children: files.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_framer_motion.motion.div,
            {
              ...
              "data-ds-animated": "",
              children: files.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                import_framer_motion.motion.div,
                {
                  layout: true,
                  ...
                  "data-ds-animated": "",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "shrink-0 size-10 rounded-md overflow-hidden bg-muted flex items-center justify-center", children: item.preview ? (
                    ...
                    ) : item.file.type.startsWith("image/") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImageFileIcon, { className: "size-5 text-muted-foreground" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileIcon, { className: "size-5 text-muted-foreground" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm font-medium text-foreground truncate", children: item.file.name }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-xs text-muted-foreground", children: [
                        formatFileSize(item.file.size),
                        item.status === "error" && item.error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-danger ml-1", children: [
                          "\u2014 ",
                          item.error
                        ] })
                      ] }),
                      item.status === "uploading" && item.progress !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-1.5 w-full h-1 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        import_framer_motion.motion.div,
                        {
