...
const calendarDayVariants = (0, import_class_variance_authority.cva)(
  [
...
const Calendar = (0, import_react.forwardRef)(
  function Calendar2({
    ...
    const [internalMonth, setInternalMonth] = (0, import_react.useState)(
    ...
    const [rangeAnchor, setRangeAnchor] = (0, import_react.useState)(null);
    const [hoverDate, setHoverDate] = (0, import_react.useState)(null);
    const navigateMonth = (0, import_react.useCallback)(
      (delta) => {
    ...
    const isDisabled = (0, import_react.useCallback)(
      (date) => {
    ...
    const getEffectiveRange = (0, import_react.useCallback)(() => {
    ...
    const getDayState = (0, import_react.useCallback)(
      (date) => {
    ...
    const handleDayClick = (0, import_react.useCallback)(
      (date) => {
    ...
    const focusedDateRef = (0, import_react.useRef)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        ...rest,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between gap-2 px-1", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 text-center text-sm font-semibold leading-none", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      showWeekNumbers && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        "div",
                        {
                      ...
                      DAYS_OF_WEEK.map((day) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        "div",
                        {
                          role: "columnheader",
                          "aria-label": day,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "div",
                  {
                    ...
                    children: weeks.map((week, weekIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "div",
                      {
                        role: "row",
                        className: (0, import_cn.cn)(
                        ...
                        children: [
                          showWeekNumbers && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-9 h-9 flex items-center justify-center text-xs text-muted-foreground/60", children: week[0] ? getWeekNumber(week[0]) : "" }),
