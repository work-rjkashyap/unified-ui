...
__export(contrast_exports, {
  DS_DARK_CRITICAL_PAIRS: () => DS_DARK_CRITICAL_PAIRS,
  DS_LIGHT_CRITICAL_PAIRS: () => DS_LIGHT_CRITICAL_PAIRS,
  WCAG_AAA_LARGE: () => WCAG_AAA_LARGE,
  WCAG_AAA_NORMAL: () => WCAG_AAA_NORMAL,
  WCAG_AA_LARGE: () => WCAG_AA_LARGE,
  WCAG_AA_NORMAL: () => WCAG_AA_NORMAL,
  WCAG_NON_TEXT_AA: () => WCAG_NON_TEXT_AA,
  auditContrast: () => auditContrast,
  checkDSContrast: () => checkDSContrast,
  checkHexContrast: () => checkHexContrast,
  contrastRatio: () => contrastRatio,
  meetsAA: () => meetsAA,
  meetsAAA: () => meetsAAA,
  meetsNonTextAA: () => meetsNonTextAA,
  parseHex: () => parseHex,
